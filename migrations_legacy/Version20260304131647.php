...
final class Version20260304131647 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        // Drop FKs that reference legacy primary keys before altering referenced tables.
        if ($this->foreignKeyExists('commande', 'FK_6EEAA67A7294869C')) {
            $this->addSql('ALTER TABLE commande DROP FOREIGN KEY `FK_6EEAA67A7294869C`');
        }
        if ($this->foreignKeyExists('historique_vue', 'FK_94C9E0E5A7294869C')) {
            $this->addSql('ALTER TABLE historique_vue DROP FOREIGN KEY `FK_94C9E0E5A7294869C`');
        }

        // Article: drop legacy FKs before dropping indexed columns (MariaDB requires this ordering).
        if ($this->foreignKeyExists('article', 'FK_23A0E6621A5CE76')) {
            $this->addSql('ALTER TABLE article DROP FOREIGN KEY FK_23A0E6621A5CE76');
        }
        if ($this->foreignKeyExists('article', 'FK_23A0E66C9486A13')) {
