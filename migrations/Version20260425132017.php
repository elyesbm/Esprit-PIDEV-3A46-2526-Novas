 ...
 */
final class Version20260425132017 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE publication (id_pub INT AUTO_INCREMENT NOT NULL, titre VARCHAR(255) NOT NULL, contenu LONGTEXT NOT NULL, image_auteur LONGTEXT NOT NULL, image_publication VARCHAR(255) DEFAULT NULL, youtube_video_id VARCHAR(20) DEFAULT NULL, statut INT NOT NULL, date_creation DATETIME NOT NULL, contexte INT NOT NULL, likes INT NOT NULL, report_count INT NOT NULL, date_modification DATETIME DEFAULT NULL, deleted_at DATETIME DEFAULT NULL, auteur_id INT NOT NULL, INDEX IDX_AF3C677960BB6FE6 (auteur_id), PRIMARY KEY (id_pub)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE publication_reaction (reaction_id INT AUTO_INCREMENT NOT NULL, value SMALLINT NOT NULL, date_creation DATETIME NOT NULL, signal_reason VARCHAR(80) DEFAULT NULL, id_pub INT NOT NULL, id_user INT NOT NULL, INDEX IDX_8BB0F2A6C4E0D4DF (id_pub), INDEX IDX_8BB0F2A66B3CA4B (id_user), UNIQUE INDEX uniq_pub_user_reaction (id_pub, id_user), PRIMARY KEY (reaction_id)) DEFAULT CHARACTER SET utf8mb4');
